...
use primitives::{ed25519, OpaqueMetadata, sr25519};
#[cfg(feature = "std")]
use primitives::bytes;
use rstd::prelude::*;
use runtime_primitives::{
    ApplyResult, create_runtime_str, generic, traits::{self, BlakeTwo256, Block as BlockT, NumberFor, StaticLookup, Verify},
